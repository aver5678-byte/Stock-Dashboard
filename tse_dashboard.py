...
def page_downward_bias():
    ...
    hud_html = f'<div style="background:#0F172A; border:4px solid #334155; border-radius:16px; padding:50px; margin-bottom:50px; box-shadow:0 30px 60px rgba(0,0,0,0.6);"><div style="display:flex; flex-direction:column; gap:40px;"><div style="display:flex; justify-content:space-between; align-items:stretch; gap:50px;"><div style="flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; border-right:2px solid rgba(255,255,255,0.1); padding-right:40px;"><div style="font-size:20px; color:#94A3B8; font-weight:800; margin-bottom:20px; display:flex; align-items:center; gap:12px;"><span style="width:12px; height:12px; background:{score_color}; border-radius:50%; box-shadow:0 0 15px {score_color};"></span>目前距離前高跌幅</div><div style="display:flex; flex-direction:column; gap:25px; align-items:center;"><div style="font-family:\'JetBrains Mono\'; font-size:92px; font-weight:950; color:{score_color}; line-height:0.9; letter-spacing:-5px; text-shadow:0 0 30px {score_color}44;">{current_dd:.1f}%</div><div style="display:flex; align-items:center; gap:15px; width:100%; justify-content:center;"><div style="flex:1; font-family:\'Inter\'; font-size:16px; font-weight:900; color:#EF4444; background:rgba(239, 68, 68, 0.15); border-radius:8px; border:2px solid rgba(239,68,68,0.4); display:flex; flex-direction:column; align-items:center; justify-content:center; padding:12px 0; min-height:65px;"><div>閾值</div><div style="font-family:\'JetBrains Mono\';">-7.0%</div></div><div style="flex:1.8; color:white; border-radius:8px; font-size:18px; font-weight:950; border:3px solid {score_color}; background:rgba(255,255,255,0.08); display:flex; align-items:center; justify-content:center; padding:12px 10px; min-height:65px; text-align:center; line-height:1.2;">{score_label}</div></div></div></div><div style="flex:2.2; background:rgba(255,255,255,0.02); padding:35px; border-radius:16px; border:1px solid rgba(56, 189, 248, 0.15);"><div style="font-size:24px; color:#38BDF8; font-weight:950; margin-bottom:30px; display:flex; align-items:center; gap:12px; border-bottom:2px solid rgba(56, 189, 248, 0.3); padding-bottom:15px;"><span style="font-size:30px;">⌛</span> 歷史反彈時程推演 (方案 A：分類精準對齊)</div><div style="display:grid; grid-template-columns:1fr; gap:10px;">{get_bar_html("📊 良性回檔模式 (< 20% DD)", norm, "#10B981")}{get_bar_html("🚨 災難崩盤模式 (>= 20% DD)", crash, "#EF4444")}</div><div style="margin-top:20px; font-size:14px; color:#64748B; font-weight:600; text-align:right; font-style:italic;">* 以上天數為「交易日」之平均值，僅供戰略參考。</div></div></div></div></div>'
    st.markdown(hud_html, unsafe_allow_html=True)
    # --- 3. 歷史分佈圖 ---

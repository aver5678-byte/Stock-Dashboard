...
def page_bias_analysis():
    ...
    if avg_b < avg_a:
        sc1_label, sc1_val, sc1_target, sc1_color = "🆘 劇本一：行情終結 (結構性重挫)", avg_b, target_b, "#EF4444"
        sc2_label, sc2_val, sc2_target, sc2_color = "✅ 劇本二：漲多修整 (回測支撐)", avg_a, target_a, "#10B981"
    else:
        sc1_label, sc1_val, sc1_target, sc1_color = "🆘 劇本一：行情終結 (結構性重挫)", avg_a, target_a, "#EF4444"
        sc2_label, sc2_val, sc2_target, sc2_color = "✅ 劇本二：漲多修整 (回測支撐)", avg_b, target_b, "#10B981"

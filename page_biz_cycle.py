...
<div style="flex:2.1; display:flex; flex-direction:column; gap:20px;"><div style="display:flex; flex-direction:column; align-items:flex-end;"><div style="text-align:right; margin-bottom:12px;"><div style="font-size:13px; color:#64748B; font-weight:800; margin-bottom:2px;">● 實戰起跑：2025/11/03 (公告後首日)</div><div style="font-size:20px; color:#F1F5F9; font-weight:900;">攻頂逃命窗口倒數 <span style="color:#7DD3FC; font-size:15px;">(目前已實戰消耗 {months_ongoing:.1f}M)</span></div></div><div style="display:flex; gap:12px;">{tiles_html}</div></div><div style="background:rgba(255,255,255,0.03); padding:15px 25px; border-radius:12px; border:1px solid #1E293B; position:relative;"><div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;"><div style="font-size:16px; color:#38BDF8; font-weight:900; letter-spacing:1px;">📊 多劇本實戰耗竭進度</div><div style="font-family:'JetBrains Mono'; font-size:14px; font-weight:800; color:#EF4444;">⚠️ 脈衝區已過，切換至 28% 擴張路徑演算</div></div><div style="height:24px; background:#0F172A; border-radius:6px; overflow:hidden; border:1px solid #334155; display:flex; position:relative;"><div style="width:25%; height:100%; background:linear-gradient(90deg, #F59E0B, #EF4444); display:flex; align-items:center; justify-content:center; color:white; font-size:10px; font-weight:900;">72% 脈衝區</div><div style="width:41%; height:100%; background:rgba(255,255,255,0.15); display:flex; align-items:center; justify-content:center; color:#CBD5E1; font-size:10px; font-weight:900;">觀察真空區</div><div style="width:34%; height:100%; background:linear-gradient(90deg, #10B981, #34D399); display:flex; align-items:center; justify-content:center; color:white; font-size:10px; font-weight:900;">28% 擴張區</div><div style="position:absolute; bottom:0; left:{marker_pos}%; transform:translateX(-50%); width:0; height:0; border-left:8px solid transparent; border-right:8px solid transparent; border-bottom:12px solid #38BDF8; filter:drop-shadow(0 0 8px #38BDF8);"></div></div><div style="display:flex; justify-content:space-between; margin-top:8px; font-size:11px; color:#94A3B8; font-weight:800; font-family:'JetBrains Mono';"><span>START</span><span>3.0M (脈衝限時)</span><span>9.0M (擴張門檻)</span><span>12M+</span></div></div><div style="font-size:12px; color:#64748B; font-weight:600; margin-top:5px; text-align:right;">「時間軸已自動校正 2 個月公佈時差，顯示為市場真實反應月份」</div></div></div></div>"""
